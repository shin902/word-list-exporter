...
**注**: XSS攻撃に対しては、HTMLエスケープや入力サニタイゼーションなどの対策を実装済みです。
...
- Gemini 2.5 Flash（推奨）: 1日あたり250リクエスト、1分あたり10リクエストまで無料
- Gemini 2.5 Flash-Lite: 1日あたり1,000リクエスト、1分あたり15リクエストまで無料
- 詳細は [Google AI Pricing](https://ai.google.dev/pricing) を参照

本アプリは画像1枚につき1リクエストを使用します。

**注**: Gemini 1.5 Flashは2025年4月に廃止されました。現在はGemini 2.5シリーズが推奨されています。
